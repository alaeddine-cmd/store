...
const FemaleSweatShirt = () => {
    ...
    function generateHoodiePaths(color) {
        ...
        return {
            front: `${base}${formattedColor}_front_sweatshirt_fem.jpg`,
            side: `${base}${formattedColor}_side_sweatshirt_fem.jpg`,
            additional: `${base}${formattedColor}_additional_sweatshirt_fem.jpg`, // Add this line
...
export default FemaleSweatShirt;
